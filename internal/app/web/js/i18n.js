(function () {
  ...
  app.translations = {
    'zh-CN': {
      ...
      'plugins.title': '运行时插件',
      'plugins.desc': '展示插件 manifest、对象校验、TC pipeline 链和运行时挂载状态；外部数据面默认关闭。',
      ...
      'plugins.catalog.hotReload': '热更新',
      'plugins.catalog.hotReloadDetail': '插件热更新：{{status}}',
      'plugins.catalog.hotReloadIdle': '待扫描',
      'plugins.catalog.hotReloadWatching': '监听中',
      'plugins.catalog.hotReloadReloaded': '已重载',
    ...
    'en-US': {
      ...
      'plugins.desc': 'Manifest, object validation, TC pipeline chain, and runtime attachment status. External dataplane is off by default.',
